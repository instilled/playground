 ...
 */
package instilled.playground.ds.tables;


import instilled.playground.ds.Keys;
import instilled.playground.ds.Sandbox;
import instilled.playground.ds.tables.records.AuthorRecord;
...
public class Author extends TableImpl<AuthorRecord> {
	...
	private static final long serialVersionUID = 1085813870;

	/**
	 * The reference instance of <code>sandbox.author</code>
	 */
	...
	/**
	 * The column <code>sandbox.author.last_name</code>.
	 */
	...
	/**
	 * Create a <code>sandbox.author</code> table reference
	 */
	public Author() {
		this("author", null);
	}
	...
	/**
	 * Create an aliased <code>sandbox.author</code> table reference
	 */
	...
	private Author(String alias, Table<AuthorRecord> aliased, Field<?>[] parameters) {
		super(alias, Sandbox.SANDBOX, aliased, parameters, "");
	}
